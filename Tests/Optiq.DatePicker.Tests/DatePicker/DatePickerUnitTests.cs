using Xunit;
using Optiq.DatePicker;

namespace Optiq.DatePicker.Tests;

public class DatePickerUnitTests
{
    [Fact]
    ...
    {
        var datePicker = new Optiq.DatePicker.DatePicker();
        datePicker.Date = initialDate;

        Optiq.DatePicker.DatePicker pickerFromSender = null;
        DateTime? oldDate = new DateTime();
        DateTime? newDate = new DateTime();

        datePicker.DateSelected += (s, e) =>
        {
            pickerFromSender = (Optiq.DatePicker.DatePicker)s;
            oldDate = e.OldDate;
            newDate = e.NewDate;
        };
    ...
    {
        var datePicker = new Optiq.DatePicker.DatePicker();
        datePicker.SetValue(Optiq.DatePicker.DatePicker.DateProperty, null);
    ...
    public void SetNullableDateTime()
    {
        ...
        datePicker.SetValue(Optiq.DatePicker.DatePicker.DateProperty, nullableDateTime);
    ...
    {
        var datePicker = new Optiq.DatePicker.DatePicker();
        datePicker.SetValue(Optiq.DatePicker.DatePicker.MaximumDateProperty, DateTime.Now);
        datePicker.SetValue(Optiq.DatePicker.DatePicker.MinimumDateProperty, DateTime.Now);
    }
}
