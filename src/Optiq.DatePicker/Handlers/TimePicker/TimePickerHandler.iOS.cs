...
public partial class TimePickerHandler : ViewHandler<ITimePicker, IOSTimePicker>
{
    protected override IOSTimePicker CreatePlatformView()
    {
    ...
    protected override void ConnectHandler(IOSTimePicker platformView)
    {
    ...
    protected override void DisconnectHandler(IOSTimePicker platformView)
    {
