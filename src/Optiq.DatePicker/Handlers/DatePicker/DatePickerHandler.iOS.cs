...
{
    protected override IOSDatePicker CreatePlatformView()
    {
        IOSDatePicker platformDatePicker = new IOSDatePicker();
    ...
    protected override void ConnectHandler(IOSDatePicker platformView)
    {
    ...
    protected override void DisconnectHandler(IOSDatePicker platformView)
    {
